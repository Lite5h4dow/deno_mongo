//import type {Timestamp, Document} from "./bson/mod.ts
import type {CollationOptions, ReadPreference, Timestamp, Document, AggregateOptions, Db, Collection, TypedEventEmitter} from "./src/types.ts
